		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li>
            	<a href="#add" data-toggle="tab"><i class="icon-plus"></i>
					<?php echo get_phrase('add_vendors');?>
                </a>
            </li>
		</ul>
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('pharmacist/update_vendor/'.$edit_vendors_list['id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('name');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="name" value="<?php echo $edit_vendors_list['name'];?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('description');?></label>
                                <div class="controls">
                                    <textarea  class="" name="description"><?php echo $edit_vendors_list['description'];?></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                ...
                <table id="vendors_list" class="display" cellspacing="0" width="100%" class="dTable responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?pharmacist/edit_vendors_details/<?php echo $row['id'];?>"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('pharmacist/add_vendor/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('Name');?></label>
                                <div class="controls">
